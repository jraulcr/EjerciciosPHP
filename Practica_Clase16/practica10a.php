...
// Obtener valores introducidos en el formulario
   ...
   // No se ha introducido ningún fichero
      else if (isset($insertar) && $_FILES['foto']['name'] == "") {
        $nombreFichero = '';
    }
...
// Si los datos son correctos, procesar formulario
   ...
   // Insertar la vivienda en la Base de Datos
      $conexion = mysqli_connect($db_host, $db_usuario, $db_contra)
       ...
       mysqli_select_db($conexion, $db_nombre) or die ("No se puede seleccionar la base de datos");
   ...
   // Mover foto a su ubicación definitiva
      ...
      print ("</UL>\n");
      print ("<P>[ <A HREF='01practica.php'>Insertar otra vivienda</A> ]</P>\n");
   }
   else
   {
?>
